...
Let's set variables:
```
SNAP_RPC="https://quicksilver-rpc.ytwofund.pro:443"
...
You can also use an alternative method and use the [Snapshot](https://github.com/YTWOFUND/Quicksilver-service/blob/main/Snapshot.md).
